        ...
        <div class="card">
            ...
            <div class="card-header">
                <ul class="nav nav-pills card-header-pills">
                    <li class="nav-item">
                        <a class="nav-link @if($tab == 'default')active fw-bold @endif" href="{{ route('topic.show', ['topic_id' => $topic->topic_id]) }}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link @if($tab == 'recent')active fw-bold @endif" href="{{ route('topic.show', ['topic_id' => $topic->topic_id, 'tab' => 'recent']) }}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link @if($tab == 'featured')active fw-bold @endif" href="{{ route('topic.show', ['topic_id' => $topic->topic_id, 'tab' => 'featured']) }}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link @if($tab == 'zeroComment')active fw-bold @endif" href="{{ route('topic.show', ['topic_id' => $topic->topic_id, 'tab' => 'zeroComment']) }}">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon me-1 d-none d-md-block" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path d="M0 0h24v24H0z" stroke="none"></path><path d="M12 12c2-2.96 0-7-1-8 0 3.038-1.773 4.741-3 6-1.226 1.26-2 3.24-2 5a6 6 0 1 0 12 0c0-1.532-1.056-3.94-2-5-1.786 3-2.791 3-4 2z"></path></svg>零评论</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link @if($tab == 'follow')active fw-bold @endif" href="{{ route('topic.show', ['topic_id' => $topic->topic_id, 'tab' => 'follow']) }}">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon me-1 d-none d-md-block" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path d="M0 0h24v24H0z" stroke="none"></path><path d="M12 12c2-2.96 0-7-1-8 0 3.038-1.773 4.741-3 6-1.226 1.26-2 3.24-2 5a6 6 0 1 0 12 0c0-1.532-1.056-3.94-2-5-1.786 3-2.791 3-4 2z"></path></svg>关注</a>
                    </li>
