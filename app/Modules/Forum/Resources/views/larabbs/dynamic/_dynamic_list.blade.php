            ...
            <li class="d-flex">
                <div class="">
                    <a href="{{ route('users.show', [$dynamic->user_id]) }}">
                        <img class="media-object img-thumbnail mr-3" style="width: 52px; height: 52px;" src="{{ $dynamic->userInfo->user_avatar }}" title="{{ $dynamic->userInfo->nick_name }}">
                    </a>
                </div>
                ...
                <div class="flex-grow-1 ms-2">
                    ...
                    <small class="media-body meta text-secondary">
                        ...
                        <a class="text-secondary" href="#" title="{{ $dynamic->topic->topic_name }}">
