...
@else
    <div class="card">
        <div class="card-body">
            <a v-if="!login_user.user_info.is_sign" @click="loginUserSign" href="javascript:;" class="btn btn-block" aria-label="Left Align" style="border-radius: 0.28571429rem;box-shadow: inset 0 0 0 1px rgba(34,36,38,.15);color: rgba(0,0,0,.6)!important;">
                <i class="fa fa-calendar-minus-o mr-2" style="opacity: .8;"></i>  立即签到
            </a>
            <a v-else href="javascript:;" class="btn btn-block" aria-label="Left Align" style="border-radius: 0.28571429rem;box-shadow: inset 0 0 0 1px rgba(34,36,38,.15);color: rgba(0,0,0,.6)!important;">
