...
class UserInfo extends Model
{
    ...
    {
        $this->attributes['basic_extends'] = my_json_encode(array_merge(json_decode($this->attributes['basic_extends'] ?? '{}', true), $value));
    }
    ...
    {
        $this->attributes['auth_extends'] = my_json_encode(array_merge(json_decode($this->attributes['auth_extends'] ?? '{}', true), $value));
    }
    ...
    {
        $this->attributes['sign_extends'] = my_json_encode(array_merge(json_decode($this->attributes['sign_extends'] ?? '{}', true), $value));
    }
    ...
    {
        $this->attributes['other_extends'] = my_json_encode(array_merge(json_decode($this->attributes['other_extends'] ?? '{}', true), $value));
    }
